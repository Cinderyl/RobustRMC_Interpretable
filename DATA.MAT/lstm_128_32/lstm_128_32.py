...
net_lstm2 = tflearn.lstm(net_lstm1, n_units=32, dropout=0.8, dynamic=True, return_seq=True)
...
model = tflearn.DNN(net, tensorboard_verbose=0, tensorboard_dir="./logs", max_checkpoints=3, best_checkpoint_path="2lstm_128_32units")
#model.load('model.tfl')

model.fit(trainX, trainY, validation_set=(valX, valY), show_metric=True,batch_size=batch_size, n_epoch=50, shuffle=True,run_id='2lstm_128_32units')
