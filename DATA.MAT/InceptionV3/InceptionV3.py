# -*- coding: utf-8 -*-
"""
Created on Mon Dec  9 20:43:31 2019
https://blog.csdn.net/tsyccnh/article/details/78889838
@author: 82045
"""
from keras.applications.inception_v3 import InceptionV3,preprocess_input
from keras.layers import Input, Add, Dense, Activation, ZeroPadding2D, BatchNormalization, Flatten, Conv2D, AveragePooling2D, MaxPooling2D,GlobalAveragePooling2D, GlobalMaxPooling2D, Reshape,Dropout
...
X = Dropout(0.5)(X)
X = Dense(229*229*3)(X)
X = Reshape([229,229,3])(X)
# 构建基础模型
base_model = InceptionV3(input_tensor=X,input_shape=(299,299,3),weights=None,include_top=False)
# 增加新的输出层
x = base_model.output
...
#%%
filepath = 'inceptionv3.h5' #所要保存的文件名字，h5格式，不用写路径，默认在程序执行的文件夹内
