...
net_lstm1 = tflearn.lstm(input_layer, n_units=64, dropout=0.8, dynamic=True, return_seq=True)
...
model = tflearn.DNN(net, tensorboard_verbose=0, tensorboard_dir="./logs", max_checkpoints=3, best_checkpoint_path="lstm_64units")
#model.load('model.tfl')

model.fit(trainX, trainY, validation_set=(valX, valY), show_metric=True,batch_size=batch_size, n_epoch=50, shuffle=True,run_id='lstm_64units')
